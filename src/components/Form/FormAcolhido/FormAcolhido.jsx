    ...
    <form className = "form-all">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" class="form-control" id="inputEmail4" placeholder="Nacionalidade"></input>
            </div>
        </div>
        ...
        <fieldset class="form-group">
            <div class="row">
                <legend class="col-form-label text-left">Tem interesse em capacitação profissional?</legend>
                <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="exampleFormControlFile1">Mande o seu currículo para futuro serviços.</label>
            <input type="file" class="form-control-file" id="exampleFormControlFile1"></input>
        </div>
    <button type="submit" url = ""class="btn btn-primary">Entrar</button>
</form>
)